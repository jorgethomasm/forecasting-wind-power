...
fig = px.line(tstates, x='Timestamp', y="State", line_shape='hv', facet_row="wt",  color="wt",
     title="Time / State Diagram for Kellmarh's Wind Turbines",
     labels={"Timestamp": "Time (UTC)", "State": "", "wt": ""})
fig.show()
