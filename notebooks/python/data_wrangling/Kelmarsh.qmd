...
....concatenate all turbine data

```{python}
#| label: one df for wt data

# # First, find the extra columns
# cols_2022_2023 = set(turbine_data_2022_2023.columns)
# cols_2017_2021 = set(turbine_data_2017_2021.columns)
# missing_cols = cols_2022_2023 - cols_2017_2021

# # Add missing columns to turbine_data_2017_2021 with NaN values
# turbine_data_2017_2021 = turbine_data_2017_2021.with_columns([
#     pl.lit(None).cast(pl.Float64).alias(col) for col in missing_cols
# ])
