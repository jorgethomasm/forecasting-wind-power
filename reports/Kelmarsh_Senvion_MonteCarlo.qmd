...
events_wide_grid$total_MW <- events_wide_grid$total *2.05
...
gen_capacity_curve <- ggplot(events_changes_zoom, aes(x = timestamp, y = MW)) + geom_step() +
...
ggimage::geom_image(
  ...
  # scale_y_continuous(labels = scales::number_format(accuracy = 0.01)) + # no decimals
  # scale_y_continuous(limits = c(0, 13), breaks = seq(0, 15, by = 2.05), minor_breaks=NULL) +  
  scale_y_continuous(minor_breaks=NULL) +    
  theme(axis.title.y = element_text(angle = 0, vjust = 0.05))
...
ggsave(filename = "./reports/online_assets/gen_capacity_curve.png", plot = gen_capacity_curve, dpi = 320, width = 800, height = 800, units = "px")
