...
# TODO: write "none" to "last seen" with state = 1 Durations. To avoid inserting unrealistic short TTFs
...
ttf_agg_year = (    
    ...
    .agg(
        ...
        pl.mean("TTF").alias("MTTF")    # Check "last seen"                  
        )         
    .sort(["Year",  "Turbine"])     
    )
...
gt_reliability = (
    ...
    .cols_label(        
        ...
        "TTR": "Duration [h]",
        "FOR": "FOR ({{P_0}})",
        "Availability": "Availability ({{P_1}})"}
    ).cols_hide(columns="Time to Failure")
)
