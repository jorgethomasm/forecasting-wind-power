...
foutages = pl.read_parquet(f"{fpath_online}{"Kelmarsh_Turbines_ForcedOutages_20160114_20230109_n892_cols12.parquet"}")
...
rel_param = rel_param.with_columns(
    pl.lit("wind-turbin-icon-10.jpg").alias("icon")
