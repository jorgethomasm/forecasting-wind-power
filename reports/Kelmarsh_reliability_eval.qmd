...
ttr_agg_year = (    
    ...
    .agg(
        ...
        pl.sum("TTR").alias("Total Repair Time"),
...
gt_reliability = (
    ...
    groupname_col = "Year")
    .tab_header(
        title="Kelmarsh Reliability Parameters",
        subtitle="Labeled forced outages (IEC) only from SCADA (2016-2022)"
    )
    #.tab_spanner(label="Time", columns=["Year", "Month", "Day"])
    #.tab_spanner(label="out-of-service", columns=["FOR", "MTTR", "Total Repair"])
